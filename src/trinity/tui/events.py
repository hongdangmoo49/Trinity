...
class TUIEventType(str, Enum):
    ...
    REVIEW_PACKAGE_QUEUED = "review_package_queued"
    REVIEW_PACKAGE_STARTED = "review_package_started"
    REVIEW_PACKAGE_COMPLETED = "review_package_completed"
    REVIEW_PACKAGE_SKIPPED = "review_package_skipped"
