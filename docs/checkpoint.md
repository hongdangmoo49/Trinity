...
- WSL 최신 전체 회귀 기록: `/home/zaemi/.local/bin/uv run pytest -q` -> `1204 passed, 2 warnings in 62.12s`
- 남은 경고: 기존 계열의 `AsyncMock`/Textual watcher runtime warning이며 slash command 보강에서 새로 도입된 실패는 아님
