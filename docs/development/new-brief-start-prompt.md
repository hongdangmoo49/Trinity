...
context, shown through `/project` diagnostics and CLI status, and injected into
...
- Preserve saved brief fields in project context, diagnostics, CLI status, and
...
- Do not change provider prompt injection or persisted Markdown output.
...
2. Keep saved brief fields in the existing project-context artifacts.
