...
_LABELS = {
    "ko": {
        ...
        "empty_filtered": "일치하는 실행 로그가 없습니다. 검색어를 지우면 전체 로그를 볼 수 있습니다.",
        "earlier_lines_hidden": "... 이전 로그 {count}줄 숨김 · 검색으로 좁혀보기",
        "match_count": "{visible}/{total}개 결과 표시",
        "no_matches": "0개 결과 · 검색어를 지우면 전체 로그 표시",
    ...
    "en": {
        ...
        "empty_filtered": "No matching execution log lines. Clear search to show all logs.",
        "earlier_lines_hidden": "... {count} earlier log lines hidden · use search to narrow",
        "match_count": "Showing {visible} of {total} matches",
        "no_matches": "0 matches · clear search to show all logs",
