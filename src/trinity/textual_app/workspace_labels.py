...
PROJECT_INTAKE_LABELS = {
    "en": {
        ...
        "target_users": "users",
        "target_mismatch": "target mismatch: saved target {target}",
        "tests": "tests",
        "tests_none": "(none)",
        "updated": "updated",
    },
    "ko": {
        ...
        "target_users": "사용자",
        "target_mismatch": "대상 불일치: 저장된 대상 {target}",
        "tests": "테스트",
        "tests_none": "(없음)",
        "updated": "갱신",
    },
...
PROJECT_DIAGNOSTIC_READINESS_LABELS = {
    "en": {
        ...
        "intake_ok": "context ok",
        "intake_missing": "context missing",
        "intake_check": "context check",
    ...
    "ko": {
        ...
        "intake_ok": "컨텍스트 정상",
        "intake_missing": "컨텍스트 없음",
        "intake_check": "컨텍스트 확인 필요",
