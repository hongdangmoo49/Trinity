...
WORKSPACE_PICKER_LABELS = {
    "en": {
        ...
        "changed_intake_reason": "saved analysis changed",
        "missing_new_project_brief_reason": "confirm prompt/work scope",
        ...
        "project_intake_safety": "Project context",
        "project_intake_safety_ok": "ok",
        "sparse_intake_reason": "saved analysis sparse",
        "stale_intake_reason": "saved analysis stale",
        "unknown": "unknown",
    ...
    "ko": {
        ...
        "changed_intake_reason": "저장된 분석 변경됨",
        "missing_new_project_brief_reason": "프롬프트/작업 범위 확인 필요",
        "new_folder": "새 폴더",
        ...
        "project_intake_safety": "프로젝트 컨텍스트",
        "project_intake_safety_ok": "정상",
        "sparse_intake_reason": "저장된 분석 부족함",
        "stale_intake_reason": "저장된 분석 오래됨",
        "unknown": "알 수 없음",
        "use_folder": "폴더 사용",
